...
> **Deploy FormaGuard?** The Autodesk Forma extension ships to **Cloudflare Pages**; the FastAPI agent ships to **Google Cloud Run** behind **Firebase Hosting** (`/api/**` rewrites). See **[DEPLOY.md](DEPLOY.md)**.
